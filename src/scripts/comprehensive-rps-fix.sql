...
IS 'Allows authenticated users to view their own profile data - fixed version to prevent 500 errors';

COMMENT ON POLICY "Educators can view profiles of students who requested their tasks" ON profiles
IS 'Allows educators to view student profiles who requested their tasks - optimized to avoid infinite recursion';

COMMENT ON POLICY "Educators can view profiles of students assigned to their tasks" ON profiles
IS 'Allows educators to view student profiles who are assigned to their tasks - optimized to avoid infinite recursion';
