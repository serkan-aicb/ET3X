...
-- This migration adds the matriculation_number column to store student matriculation numbers
...
COMMENT ON COLUMN profiles.matriculation_number IS 'Student matriculation number for identification';
