...
/**
 * Governed skill typeahead (v1.6 §7): search the 497-label catalogue
 * (case-insensitive), show "counts toward <capability>" on each result and
 * each selection, and log zero-match searches for monthly label additions.
 * No free-text skills — selection is always a real catalogue skill_id.
 */
